...
protected:
	...
	GUI::Window wContent;    ///< Contains wEditor, wGroupTab, wConsole and wOutput
	GUI::ScintillaWindow wEditor;
	GUI::ScintillaWindow wOutput;
	GUI::ScintillaWindow wConsole;
	GUI::Window wIncrement;
	GUI::Window wToolBar;
	GUI::Window wStatusBar;
	GUI::Window wTabBar;
	GUI::Window wGroupTab;
	GUI::Menu popup;
	bool tbVisible;
	bool tabVisible;
