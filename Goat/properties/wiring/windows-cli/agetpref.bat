...
REM ---------------------------------------------------------------------------
REM     Verify ARDUINO_VARIANTS
if not defined arduino_variants (
    !abuild_error! The environment variable ARDUINO_VARIANTS must be defined the variants (e.g. standard^).
    goto end
)

REM ---------------------------------------------------------------------------
REM     Verify ARDUINO_CORE
if not defined arduino_core (
    !abuild_error! The environment variable ARDUINO_CORE must be defined the variants (e.g arduino^).
    goto end
)

set arduino_runtime_pde=!arduino_path!\hardware\cores\!arduino_core!
set arduino_runtime_ino=!arduino_path!\hardware\arduino\cores\!arduino_core!
